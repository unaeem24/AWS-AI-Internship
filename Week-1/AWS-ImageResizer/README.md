...
![Bucket](./Images/S3-upload-bucket.png)

### Destination Bucket(Resized Image)

![Bucket](./Images/S3-destination-bucket.png)
...
![Lambda Function](./Images/ImageResizerLambda.png)
...
![EventBridge](./Images/Updated-EODCleanup.png)
...
![EODCleanup](./Images/EODCleanup.png)
